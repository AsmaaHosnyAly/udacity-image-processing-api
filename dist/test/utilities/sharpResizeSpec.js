...
describe("Sharp", function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    height = 300;
                    width = 300;
                    resizePath = "./resizedImages/".concat(filename).concat(width, "x").concat(height, ".jpg");
                    return [4 /*yield*/, (0, utilities_1.sharpResize)(filename, height, width)];
                case 1:
                    response = _a.sent();
    ...
    it("Expect create a resized image", function (done) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    height = 200;
                    width = 500;
                    testPath = "./src/test/images/".concat(filename).concat(width, "x").concat(height, ".jpg");
                    return [4 /*yield*/, (0, utilities_1.sharpResize)(filename, height, width)];
                case 1:
                    response = _a.sent();
                    return [4 /*yield*/, response.toFile(testPath, function () { return __awaiter(void 0, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, (0, utilities_1.fileExisits)(testPath)];
                                    case 1:
                                        d = _a.sent();
